...
if __name__ == "__main__":
	...
	sqlDFb = spark.sql("Select AVG(rating) as avg_rating, genres from ratings, movies where movies.movie_id = ratings.movie_id group by genres order by AVG(rating) desc")
	sqlDFb.show()
	spark.stop()
